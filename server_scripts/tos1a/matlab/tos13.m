...
function Outputs(block)
	...
	% output_path = block.DialogPrm(7).Data;
        ...
        %fprintf(fid,'%s\n',newValues);
        fprintf(fid,'%s\n',strcat(num2str(block.CurrentTime),',',newValues,',',num2str(block.InputPort(1).Data),',',num2str(block.InputPort(3).Data),',',num2str(block.InputPort(2).Data)));
        fclose(fid);
    catch err
